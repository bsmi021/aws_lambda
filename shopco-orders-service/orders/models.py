...
class Order(DeclarativeBase):
    ...
    def __repr__(self):
        return "<Order(id='%s', order_date='%s', order_id='%s'>" % (self.id, self.order_date, self.order_id)

    def __init__(self, order_id, customer_id, order_date, address = None):
        self.order_status_id = OrderStatus.Submitted.value
        self.order_id = order_id
        self.customer_id = customer_id
        self.address = address
        self.order_date = order_date#datetime.datetime.utcnow()
